...
von Bedeutung sein werden. Ein großer Teil der Arbeit baut auf Relationen auf, weshalb neben grundsätzlichen mathematischen
Notationen vor allem Definitionen und Notationen eingeführt werden, die Relationen betreffen.

Neben mathematischen Grundlagen sind auch Haskell-Kenntnisse erforderlich. Es soll hier nicht darum gehen, die komplette 
Programmiersprache Haskell zu beschreiben, aber es wird auf das Konzept der Typkonstruktorklassen eingegangen, da diese
...
Die Bibliothek \textit{free-theorems}, auf der diese Arbeit basiert, wird beschrieben in \cite{freetheorems}. Die in diesem Abschnitt
...
um Relationen zu beschreiben und mit diesen zu arbeiten. \todo{Quellen?}
...
erfüllen, jeweils das Paar der Suprema ($\sqcup{\bar{x}}, \sqcup{\bar{y}})$ \todo{Bessere Notation für Supremum} in $\mathcal{R}$ ist, dann nennt man $\mathcal{R}$ \textit{stetig}. Eine Relation ist \textit{zulässig}, wenn sie strikt und stetig ist.
...
Typklassen in Haskell ermöglichen die Umsetzung von Ad-Hoc-Polymorphismus. \todo{zitat} Man kann beliebige Typklassen selbst definieren,
