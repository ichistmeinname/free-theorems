...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 \todo{Mathematische Grundlagen mit Quellen? Teilweise von Böhme übernommen}
...
Eine partielle Ordnung $\sqsubseteq : M \Leftrightarrow M$ ist eine Relation, die \textit{reflexiv}, \textit{antisymmetrisch} und \textit{transitiv} ist \todo{das kommt von wikipedia!}, d.h. es gelten die folgenden Aussagen für alle $x, y, z \in M$.
...
erfüllen, jeweils das Paar der Suprema ($\sqcup{\bar{x}}, \sqcup{\bar{y}})$ \todo{Latex-Notation für Supremum?} in $\mathcal{R}$ ist, dann nennt man $\mathcal{R}$ \textit{stetig}. Eine Relation ist \textit{zulässig}, wenn sie strikt und stetig ist.
...
ohne dieses Konstrukt. \todo{Quelle! (stimmt das überhaupt?)}
...
Hat man eine Typklasse definiert, kann man Typvariablen 
