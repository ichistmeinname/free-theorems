...
Eine partielle Ordnung $\sqsubseteq$ ist eine Relation, die \textit{reflexiv}, \textit{antisymmetrisch} und \textit{transitiv} ist \todo{das kommt von wikipedia!}, d.h. es gelten:
...
Ist Y eine Menge und X eine geordnete Menge, dann nennt man eine Relation $\mathcal{R} \subseteq X \times Y$ \textit{links-abgeschlossen},
