...
\begin{minted}{haskell}
(ForallRelations (RVar "R") ("t1", "t2")
   (ForallPairs ("x", "y")
      (RelLift ("[t1]", "[t2]") ConList (RelVar "R"))
      (Predicate
         (IsMember "test_{t1} x" "test_{t2} y"
            (RelLift ("[t1]", "[t2]") ConList (RelVar "R"))))
   )
)
\end{minted}

% TODO: das hier ist die nicht-spezialisierte variante. muss auch noch im code ermoeglicht werden.